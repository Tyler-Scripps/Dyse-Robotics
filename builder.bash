...
buildWorkSpace()
{
	...
	if [[ -n ${PARAMS[INSTALL]} ]]; then
		...
		CMD="rm -rf dyse-robotics || git clone https://github.com/mitchelldscott/dyse-robotics.git && touch mark.txt && cd dyse-robotics && git checkout install && ./builder.bash -o ${PARAMS[CONFIG]}"
