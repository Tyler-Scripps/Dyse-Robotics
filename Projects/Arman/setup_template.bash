...
export PYTHONPATH=/opt/ros/melodic/lib/python2.7/dist-packages:${DIR}/arman_tools
echo "alias load_arman='export PYTHONPATH=$PYTHONPATH && source ${DIR}/devel/setup.bash && source ${ENV_PATH}/${ENV_NAME}/bin/activate'" >> ~/.bashrc
